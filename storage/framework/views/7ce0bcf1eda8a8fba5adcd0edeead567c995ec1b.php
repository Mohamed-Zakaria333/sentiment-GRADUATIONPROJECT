<?php /* C:\xampp\htdocs\ec_projects\own\resources\views/website/layouts/header.blade.php */ ?>
<!--
Author: W3layouts
...
<body>
	...
	<div class="agile-main-top">
     ...
     <?php if(Auth::user()->isAdmin==1): ?>
            	<li class="text-center border-right text-white">
							<a id="go_login_form" href="#" data-toggle="modal" data-target="#exampleModal" class="text-white">
								<i class="fas fa-sign-in-alt mr-2"></i> Log In </a>
						</li>
						<li class="text-center text-white">
							<a id="go_register_form" href="#" data-toggle="modal" data-target="#exampleModal2" class="text-white">
...
<!-- modals -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form  method="POST" action="<?php echo e(route('custom_login')); ?>" >
						<?php echo csrf_field(); ?>
						               <?php if($message = Session::get('success')): ?>
                                       <div class="alert alert-danger" role="alert">
                                      member not found in our databases
                                       </div>
                                              <?php endif; ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="email" require="">
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="POST" action="<?php echo e(route('custom_register')); ?>">
						<?php echo csrf_field(); ?>
						   <?php if(count($errors) > 0): ?>
                           <div class="alert alert-danger">
                                <ul>
			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="<?php echo e(route('Home')); ?>" class="font-weight-bold font-italic">
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<div class="col-10 agileits_search" >
							<form  class="form-inline" action="<?php echo e(route('searching',['cata' => 'option'])); ?>" method="POST" id="catagories">
								<?php echo csrf_field(); ?>
    ...
    <option value ="Cameras_flashes">Cameras_flashes</option>
								...
								<button class="agileits-navi_search" type="submit">Search</button>
							</form>
						</div>
						<!-- //search -->
                     ...
                     ?>
						...
						<div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
							<div class="wthreecartaits wthreecartaits2 cart cart box_1">
								<form action="<?php echo e(route('CART')); ?>" method="POST" class="last">
									<?php echo csrf_field(); ?>
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="display" value="1">
									<button class="btn w3view-cart" style="width: 120px" type="submit" name="submit" value="">
										<i class="fas fa-cart-arrow-down" ><span class="badge" style="background-color: green;margin-left: 20px"><?php echo e(count(session('cart'))); ?></span></i>
									</button>
								</form>
							</div>
						</div>
