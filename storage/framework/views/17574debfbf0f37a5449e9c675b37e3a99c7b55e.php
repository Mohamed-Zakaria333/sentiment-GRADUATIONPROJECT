<?php /* C:\xampp\htdocs\ec_projects\own\resources\views/admin/email_template.blade.php */ ?>
<!DOCTYPE html>
<html lang="en" >
...
<div class="email">
  ...
  <img class="logo" src="<?php echo e(url($slidingimages_admin_path)); ?>/website_logo.PNG">


  <img src="<?php echo e(url($uploaded_img_path)); ?>/<?php echo e($data['pro_img']); ?>">

  <div class="white-container">
    <h2>Dear: <?php echo e($data['fname']); ?> <?php echo e($data['lname']); ?></h2>

    <h3><?php echo e($data['content']); ?>.</h3>

    <a href="<?php echo e(route('Home')); ?>" class="button">shop for more products</a>
    
  </div>
  <div class="links">
    <a class="link" href="#">Cobalt Solutions | </a>
